...
import { FaCheckCircle, FaPhoneAlt, FaMapMarkerAlt, FaPen } from 'react-icons/fa';
            ...
            <div className='space-y-4 p-5'>
                ...
                <div className='flex flex-col lg:flex-row lg:justify-between gap-8 text-primary'>
                    ...
                    <div className='font-semibold flex flex-col gap-2 w-full lg:w-1/2 sm:text-left text-center items-center sm:items-start'>
                        ...
                        <p className='flex gap-2 items-center'> <FaPhoneAlt className='text-secondary' /> {mobile}</p>
